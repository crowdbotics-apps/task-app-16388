"""task_app_16388 URL Configuration
...
admin.site.site_title = "task-app Admin Portal"
admin.site.index_title = "task-app Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="task-app API",
        default_version="v1",
        description="API documentation for task-app App",
    ),
    public=True,
